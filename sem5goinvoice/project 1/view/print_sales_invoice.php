...
// Fetch invoice, customer, items, user profile (logo)
...
<body>
  <div class="invoice-container" id="invoice">
    ...
    <div class="customer-details">
      ...
      <div class="form-row">
        <div class="form-group">
          <label>M/S</label>
          <input value="<?php echo e($inv['customer_name']); ?>">
        </div>
        <div class="form-group">
          <label>GSTIN</label>
          <input value="<?php echo e($inv['customer_gst'] ?? ''); ?>">
        </div>
      </div>
      <div class="form-row">
        <div class="form-group">
          <label>Address</label>
          <textarea><?php echo e($inv['customer_address'] ?? ''); ?></textarea>
        </div>
      </div>
    </div>
  ...
  <script>
    function generatePDF(){
      ...
      const opt = { margin:[5,5,5,5], filename:'invoice-<?php echo e($inv['invoice_number']); ?>.pdf', image:{type:'jpeg',quality:0.98}, html2canvas:{scale:2, useCORS:true, width:800, windowWidth:800}, jsPDF:{unit:'mm', format:'a4', orientation:'portrait'} };
